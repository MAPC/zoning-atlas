...
const RightCalloutSection = ({ content, calloutContent, marginTop }) => (
  <div className="report-section">
    <div className={marginTop ? `report-section__right-callout` : `report-section__right-callout report-section__right-callout--no-margin`}>
      ...
      <div className="report-section__right-callout-content">
        <div dangerouslySetInnerHTML={{ __html: content.html }} className="report-section__right-callout-text" className="report-section__content" />
